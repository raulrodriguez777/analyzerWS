...
public class DecodeHtmlProvider {

	private static Logger logger = Logger.getLogger(DecodeHtmlProvider.class);
	...
	public static String decode(String s) {
		...
		try {
			...
			logger.error("Se ha producido un error en la decodificación del html", e);
			return null;
		}
